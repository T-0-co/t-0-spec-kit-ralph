...
- \`hf-app-docker-dev-server\`: Start/stop Docker dev servers (ports 3000, 3001)
- \`hf-app-api-test-runner\`: Test API endpoints
- \`autonomous-development\`: TDD workflow and loop-closing patterns
- Check \`.claude/skills/\` for more
